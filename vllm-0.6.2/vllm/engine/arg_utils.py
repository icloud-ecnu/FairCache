...
class EngineArgs:
    ...
    enable_fair_computation: Optional[bool] = None
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            action=StoreBoolean,
            default=EngineArgs.enable_fair_computation,
            nargs="?",
            const="True",
            help='If set, fair computation scheduling mode will be enabled.')
    ...
    def create_engine_config(self) -> EngineConfig:
        ...
        scheduler_config = SchedulerConfig(
            ...
            enable_fair_computation=self.enable_fair_computation
        )
