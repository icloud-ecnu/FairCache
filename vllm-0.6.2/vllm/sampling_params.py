...
class SamplingParams(
    ...
    # Record the client_id of the request for fair scheduling
    client_id: Optional[int] = None

    # Mark whether the request has been preempted. 
    # If it has been preempted, future prefills will no longer be charged.
    preempted: Optional[bool] = None
