...
class LMCacheEngineConfig:
    ...
    enable_fair_caching: bool # whether to enable fair caching
    ...
    def from_defaults(
            ...
            enable_fair_caching: bool = False
    ) -> "LMCacheEngineConfig":
        return LMCacheEngineConfig(
            ...
            blend_separator, blend_add_special_in_precomp, enable_fair_caching)
    ...
    def from_file(file_path: str) -> "LMCacheEngineConfig":
        ...
        blend_add_special_in_precomp = config.get(
            "blend_add_special_in_precomp", False)
        enable_fair_caching = config.get("enable_fair_caching", False)
    ...
    def from_env() -> "LMCacheEngineConfig":
        ...
        config.enable_fair_caching = parse_env(get_env_name("enable_fair_caching"),
                      config.enable_fair_caching)
